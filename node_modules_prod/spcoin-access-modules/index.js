...
class SpCoinAccessModules {
    ...
    this.spCoinAddMethods = new SpCoinAddModule(this.spCoinContractDeployed, signer);
    this.spCoinDeleteMethods = new SpCoinDeleteModule(this.spCoinContractDeployed, signer);
    this.spCoinERC20Methods = new SpCoinERC20Module(this.spCoinContractDeployed, signer);
    this.spCoinLogger = new SpCoinLogger(this.spCoinContractDeployed);
    this.spCoinReadMethods = new SpCoinReadModule(this.spCoinContractDeployed, signer);
    this.spCoinRewardsMethods = new SpCoinRewardsModule(this.spCoinContractDeployed, signer);
    this.spCoinStakingMethods = new SpCoinStakingModule(this.spCoinContractDeployed, signer);
  }
